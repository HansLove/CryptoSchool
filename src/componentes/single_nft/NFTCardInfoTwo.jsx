...
function NFTCardInfoTwo({NFTImage, NFTName, NFTSystem, NFTOwnerName, NFTOwnerImage, NFTValue}) {
  return (
    <div className="card-info-nft-container">
